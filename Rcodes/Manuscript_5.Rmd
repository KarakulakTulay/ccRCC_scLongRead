...
```{r SelectCounts}
## Normal
Normal_counts <- as.data.frame(as.matrix(healthy_isoform[["RNA"]]$counts))
...
## ccRCC2
ccRCC2_counts <- as.data.frame(as.matrix(ccRCC_2_isoform[["RNA"]]$counts))
...
### ccRCC3
ccRCC3_counts <- as.data.frame(as.matrix(ccRCC_3_isoform[["RNA"]]$counts))
...
## ccRCC4
ccRCC4_counts <- as.data.frame(as.matrix(ccRCC_4_isoform[["RNA"]]$counts))
...
## ccRCC5
ccRCC5_counts <- as.data.frame(as.matrix(ccRCC_5_isoform[["RNA"]]$counts))
...
```{r readMDTs}
ccRCC5_mdts_neg_filt2 <- readRDS('/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/ccRCC5_mdts_neg_tama.RDS')
ccRCC4_mdts_neg_filt2 <- readRDS('/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/ccRCC4_mdts_neg_tama.RDS')
ccRCC2_mdts_neg_filt2 <- readRDS('/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/ccRCC2_mdts_neg_tama.RDS')
ccRCC5_mdts_pos_filt2 <- readRDS('/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/ccRCC5_mdts_pos_tama.RDS')
ccRCC4_mdts_pos_filt2 <- readRDS('/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/ccRCC4_mdts_pos_tama.RDS')
ccRCC2_mdts_pos_filt2 <- readRDS('/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/ccRCC2_mdts_pos_tama.RDS')
Normal_mdts_pos_filt2 <- readRDS('/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/Normal_mdts_pos_tama.RDS')
ccRCC3_mdts_pos_filt2 <- readRDS('/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/ccRCC3_mdts_pos_tama.RDS')
```
...
```{r saveRDSSwitches_1}
saveRDS(ccRCC2_mdts_pos_neg_switch_remaining, '/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/ccRCC2_mdts_pos_neg_switch_tama_part1.RDS')

saveRDS(ccRCC4_mdts_pos_neg_switch_remaining, '/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/ccRCC4_mdts_pos_neg_switch_tama_part.RDS')

saveRDS(ccRCC5_mdts_pos_neg_switch_remaining, '/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/ccRCC5_mdts_pos_neg_switch_tama_part1.RDS')
```
...
filter_same_transc <- function(switches, annotation) {
  ...
  for(each_row in 1:nrow(switches)) {
    ...
    dMDT_transcript <- unique(annotation[annotation$TamaID == dMDT_in_row, 'associated_transcript'])
    MDT_transcript <- unique(annotation[annotation$TamaID == MDT_in_row, 'associated_transcript'])
    
    if (length(dMDT_transcript) == 1 && length(MDT_transcript) == 1) {
      
      if (dMDT_transcript  != 'novel' & MDT_transcript != 'novel') { # to include novels
      
      if (dMDT_transcript == MDT_transcript) {
        
        dMDT_list <- c(dMDT_list, dMDT_in_row)
        remove_rows <- c(remove_rows, each_row)
      }      
    
      }
  } else if(any(dMDT_transcript %in% MDT_transcript)) {
      
      if(!'novel' %in% dMDT_transcript) { # to include novels
   ...
   switches_filtered2 <- switches[!switches$dMDT %in% dMDT_list,]
   return(switches_filtered2)
  
}  

ccRCC4_switches_filtered <- filter_same_transc(ccRCC4_switches_split, isoform_annotations_ccRCC4_tama) # 3677   12
ccRCC2_switches_filtered <- filter_same_transc(ccRCC2_switches_split, isoform_annotations_ccRCC2_tama) # 16201    12
ccRCC5_switches_filtered <- filter_same_transc(ccRCC5_switches_split, isoform_annotations_ccRCC5_tama) # 35452    12
``` 


```{r saveRDSSwitches}
saveRDS(ccRCC2_switches_filtered, '/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/ccRCC2_mdts_pos_neg_switch_tama_part2.RDS')

saveRDS(ccRCC4_switches_filtered, '/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/ccRCC4_mdts_pos_neg_switch_tama_part2.RDS')

saveRDS(ccRCC5_switches_filtered, '/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/ccRCC5_mdts_pos_neg_switch_tama_part2.RDS')
...
read files
```{r readRDSSwitches}
ccRCC2_switches_filtered <- readRDS('/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/ccRCC2_mdts_pos_neg_switch_tama_part2.RDS')

ccRCC4_switches_filtered <- readRDS( '/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/ccRCC4_mdts_pos_neg_switch_tama_part2.RDS')

ccRCC5_switches_filtered <- readRDS('/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision/MDTSwitches/ccRCC5_mdts_pos_neg_switch_tama_part2.RDS')
...
```{r mergeResults}
ccRCC2_switches_cMDT_TamaID <- merge(ccRCC2_switches_filtered, isoform_annotations_ccRCC2_tama[, c(1,2, 4, 5, 6, 7, 8, 9, 10, 52)], by.x = 'dMDT', by.y = 'TamaID') 
ccRCC2_switches_cMDT_TamaID_MDT <- merge(ccRCC2_switches_cMDT_TamaID, isoform_annotations_ccRCC2_tama[, c(1, 6, 8, 52)], by.x = 'MDT_GTEx', by.y = 'TamaID')
ccRCC2_switches_cMDT_TamaID_MDT_filt <- ccRCC2_switches_cMDT_TamaID_MDT[, c(1,2,4, 13, 15, 16, 17, 18, 19, 21, 22, 23, 24, 25, 26)] %>% dplyr::distinct()
colnames(ccRCC2_switches_cMDT_TamaID_MDT_filt) <- c('MDT', 'cMDT', 'GeneName', 'Cohort', 'PBid_Cancer', 'chrom', 'length_of_cMDT', 'exons_of_cMDT', 'structural_category_cMDT', 'associated_transcript_cMDT', 'ref_length', 'ref_exon', 'PBid_MDT', 'structural_category_MDT', 'associated_transcript_MDT')

ccRCC4_switches_cMDT_TamaID <- merge(ccRCC4_switches_filtered, isoform_annotations_ccRCC4_tama[, c(1,2, 4, 5, 6, 7, 8, 9, 10, 52)], by.x = 'dMDT', by.y = 'TamaID')
ccRCC4_switches_cMDT_TamaID_MDT <- merge(ccRCC4_switches_cMDT_TamaID, isoform_annotations_ccRCC4_tama[, c(1, 6, 8, 52)], by.x = 'MDT_GTEx', by.y = 'TamaID')
ccRCC4_switches_cMDT_TamaID_MDT_filt <- ccRCC4_switches_cMDT_TamaID_MDT[, c(1,2,4,13, 15, 16, 17, 18, 19, 21, 22, 23, 24, 25, 26)] %>% dplyr::distinct()
colnames(ccRCC4_switches_cMDT_TamaID_MDT_filt) <- c('MDT', 'cMDT', 'GeneName','Cohort', 'PBid_Cancer', 'chrom', 'length_of_cMDT', 'exons_of_cMDT', 'structural_category_cMDT', 'associated_transcript_cMDT', 'ref_length', 'ref_exon', 'PBid_MDT', 'structural_category_MDT', 'associated_transcript_MDT')

ccRCC5_switches_cMDT_TamaID <- merge(ccRCC5_switches_filtered, isoform_annotations_ccRCC5_tama[, c(1,2, 4, 5, 6, 7, 8, 9, 10, 52)], by.x = 'dMDT', by.y = 'TamaID')
ccRCC5_switches_cMDT_TamaID_MDT <- merge(ccRCC5_switches_cMDT_TamaID, isoform_annotations_ccRCC5_tama[, c(1, 6, 8, 52)], by.x = 'MDT_GTEx', by.y = 'TamaID')
ccRCC5_switches_cMDT_TamaID_MDT_filt <- ccRCC5_switches_cMDT_TamaID_MDT[, c(1,2,4,13,15,16,17,18, 19, 21, 22, 23, 24, 25, 26)] %>% dplyr::distinct()

colnames(ccRCC5_switches_cMDT_TamaID_MDT_filt) <- c('MDT', 'cMDT', 'GeneName','Cohort', 'PBid_Cancer', 'chrom', 'length_of_cMDT', 'exons_of_cMDT', 'structural_category_cMDT', 'associated_transcript_cMDT', 'ref_length', 'ref_exon', 'PBid_MDT', 'structural_category_MDT', 'associated_transcript_MDT')
```
...
#write.table(ccRCC_All_Switches, #'/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision_Codes_Supple#mentaries/SupplementaryTables/SupplementaryFile_3.tsv', quote = FALSE, row.names = #FALSE, sep = '\t')
```

```{r mergeNumberOfCellswithAnnotations}
ccRCC2_switches_cMDT_TamaID_MDT_filt_numberOfCell <- merge(ccRCC2_switches_cMDT_TamaID_MDT_filt, ccRCC2_switches[,c(1,3)], by.x = 'cMDT', by.y = 'cMDT_TamaID')
ccRCC4_switches_cMDT_TamaID_MDT_filt_numberOfCell <- merge(ccRCC4_switches_cMDT_TamaID_MDT_filt, ccRCC4_switches[,c(1,3)], by.x = 'cMDT', by.y = 'cMDT_TamaID')
ccRCC5_switches_cMDT_TamaID_MDT_filt_numberOfCell <- merge(ccRCC5_switches_cMDT_TamaID_MDT_filt, ccRCC5_switches[,c(1,3)], by.x = 'cMDT', by.y = 'cMDT_TamaID')


ccRCC_All_Switches_annot <- (rbind(ccRCC2_switches_cMDT_TamaID_MDT_filt_numberOfCell, ccRCC4_switches_cMDT_TamaID_MDT_filt_numberOfCell, ccRCC5_switches_cMDT_TamaID_MDT_filt_numberOfCell) %>% dplyr::arrange(desc(CellNumber)))
write.table(ccRCC_All_Switches_annot, '/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision_Codes_Supplementaries/SupplementaryTables/SupplementaryFile_3_annotations.tsv', quote = FALSE, row.names = FALSE, sep = '\t')
```
...
ccRCC_mdts_pos_neg <- rbind(ccRCC2_mdts_neg_filt2, ccRCC2_mdts_pos_filt2, ccRCC4_mdts_neg_filt2, ccRCC4_mdts_pos_filt2, ccRCC5_mdts_neg_filt2, ccRCC5_mdts_pos_filt2, ccRCC3_mdts_pos_filt2, Normal_mdts_pos_filt2)
