...
ccRCC and nonccRCC Explicit Isoforms - it is not added to the manuscript
```{r isoformTypes2}
# Sample 2
...
write.table(SuppTable2, '/Users/tulaykarakulak/Desktop/Desktop2/ManuscriptSubmission/ccRCC_Revision_Codes_Supplementaries/SupplementaryTables/SupplementaryFile_2.tsv', quote = FALSE, row.names = FALSE, sep = '\t')
```
...
wp_result
ggsave("Figure3F.png", plot = wp_result, bg = "transparent", width = 8, height = 10)

#ggsave("Figure3F_emHallmark.png", plot = emH_result, bg = "transparent", width = 8, height = 10)
```
